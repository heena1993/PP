<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="DoctorsProfile.aspx.cs" Inherits="DoctorsProfile" %>
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-sm-6 form-group" style="text-align: left;">
                                                    <asp:Label ID="lblHospitalName" runat="server" Text="" ForeColor="#293faf"></asp:Label>
                                                    <br />
                                                </div>
                                            </div>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-sm-6 form-group" style="text-align: left;">
                                                    <asp:Label ID="lblQualification" runat="server" Text="" ForeColor="#293faf"></asp:Label>
                                                    <br />
                                                </div>
                                            </div>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-sm-6 form-group" style="text-align: left;">
                                                    <asp:Label ID="lblSpecialist" runat="server" Text="" ForeColor="#293faf"></asp:Label>
                                                    <br />
                                                </div>
                                            </div>
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="row">
                                                        ...
                                                        <div class="col-sm-6 form-group" style="text-align: left;">
                                                            <asp:TextBox ID="txtHospitalName" runat="server" AutoPostBack="true" OnTextChanged="txtHospitalName_TextChanged" placeholder="Enter Hospital Name Here...." class="form-control"></asp:TextBox>
                                                            <asp:Label ID="lblHospitalNameError" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                      ...
                                                      <div class="row">
                                                        ...
                                                        <div class="col-sm-6 form-group" style="text-align: left;">
                                                            <asp:TextBox ID="txtQualification" runat="server" AutoPostBack="true" OnTextChanged="txtQualification_TextChanged" placeholder="Enter Qualification Here...." class="form-control"></asp:TextBox>
                                                            <asp:Label ID="lblQualificationError" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 form-group" style="text-align: left;">
                                                            <asp:TextBox ID="txtSpecialist" runat="server" AutoPostBack="true" OnTextChanged="txtSpecialist_TextChanged" placeholder="Enter Specialist Here...." class="form-control"></asp:TextBox>
                                                            <asp:Label ID="lblSpecialistError" runat="server" Text="" ForeColor="Red"></asp:Label>
